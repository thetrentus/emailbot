...
#
# Step 3 - In line 8, replace [password] with your gmail account's password. (Example:  Pass = "StrongPassword15" )
# Note: The password is case sensitive and will NOT be send with the email. 
#
# Step 4 - In line 9, replace [Your name] with your name. (Example: Name = "Peter Clark" )
# Note: Don't use your actual name. Use a nickname! 
#
# Step 5 - In line 10, replace [Opponent Email] with the email you want to spam. (Example: Input = "example.mail@gmail.com" )
# 
# Step 6 - In line 11, replace [Title] with the title of the spam email. (Example: Input2 = "This is Spam" )
#
# Step 7 - In line 12, replace [Body] with what the email should include. (Example: Input3 = "Spam Spam Spam Spam Spam" )
